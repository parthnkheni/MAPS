...
1. **Remote Start** – Waits for ultrasonic trigger (hand wave)  
2. **Line Following** – Continuously tracks tape using IR sensors  
3. **Obstacle Detection** – Stops motion if object <10cm; resumes once cleared  
4. **Finish Line Detection** – Stops robot when finish tape detected  

> A full technical flowchart is provided in the project presentation.
...
Special thanks to our professors, TAs, classmates, EPIC employees, and the BU engineering community for supporting this project. Diagrams designed using [Slidesgo](https://slidesgo.com), [Flaticon](https://flaticon.com), and [Freepik](https://freepik.com).
